...
public class Koordinatengitter extends JPanel {
	...
	public void erzeugeKoordinatengitter(String crs, double minE, double minN, double maxE, double maxN,
		...
		if (betaiteration < 1.00) {
			...
			// Ausserdem wird noch ein Startwert benötigt, um von diesem die
			// Koordinatenwerte abzutragen:
		...
		// Startwert keine zu große Lücke ist, wird manuell ein Breitengrad
		// davorgeschoben
